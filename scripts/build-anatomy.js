#!/usr/bin/env node
/**
 * Описательный скелет SVG: контуры и воспроизводимые геометрические измерения.
 * Выход — dist/anatomy.json. Единицы, дискретизация и округление определены
 * реализацией ниже; структура и ограничения — docs/anatomy-model.md.
 * Ориентационные признаки не заменяют SVG-рендеринг и не устанавливают
 * смысловые части, корректность анимации или готовность выходного адаптера.
 */
