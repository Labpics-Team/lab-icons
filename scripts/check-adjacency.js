 ...
 * частей и величиной зазора. ε относителен канве (24). Части в РАЗНЫХ компонентах
...
const CANVAS = 24; // viewBox корпуса; ε ниже — доля канвы
const EPS = 0.15; // зазор (юниты канвы) выше которого части считаются РАЗОРВАННЫМИ
const TOUCH = 0.9; // ширина «примыкания» части к компоненте руки (полуширина штриха канвы)
