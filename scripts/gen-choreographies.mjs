...
const iconMotions = {
  ...
  // Переключение камеры = зеркальный флип стрелок (C2-глиф: -1 визуально
  // эквивалентен развороту цикла; identity-край через возврат).
  'flip-x': {
    duration: 0.7,
    tracks: [{ property: 'scaleX', values: [1, -1, 1], times: [0, 0.5, 1], easing: e.easeInOut }],
  },
