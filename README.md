...
Библиотека статических SVG и геометрического представления иконок Labpics.
Статические иконки наследуют `currentColor`. Параметрическая модель, оптические
оси и смысловые жесты доступны только для вариантов, прошедших соответствующие
проверки; наличие SVG само по себе этих возможностей не обещает.
