...
каталоге как исторический эксперимент, а не часть runtime. Соседние тесты
обнаруживаются общим Vitest-запуском; полное повторение эксперимента требует
отдельного запуска скриптов на закреплённых входах. Решение — discard.
